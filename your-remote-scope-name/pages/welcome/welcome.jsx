...
import { Card } from "@your-bit-dev-username/your-remote-scope-name.ui.card";
  ...
  return (
    <div className={styles.page}>
      ...
      <Text
        ...
        text="Edit this component and see it change"
      />
      ...
      <Text
        className={styles.texts}
        text="Understanding Bit's commands better"
      />
